...
return {
	...
	on_enter = function()
		navigator = navigation.new({ pool.walkietalkie, pool.datapad, pool.idmanual, pool.panicbutton })
		interact = interaction.new({ pool.walkietalkie, pool.datapad, pool.idmanual, pool.panicbutton })
